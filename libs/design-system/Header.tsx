  ...
  return (
    <header className="flex h-[64px] w-full items-center justify-center border-b border-[#D7D7D7]">
      <div className="relative flex h-full w-[360px] items-center justify-between px-5 md:w-[1100px]">
        ...
        <div className="ml-auto flex h-[38px] w-[120px] items-center justify-center rounded-[4px] bg-[#D7D7D7] px-3 py-2 text-center">
          <span className="text-base font-semibold leading-[140%] tracking-[-0.02em] text-white">
            다음으로
          </span>
        </div>
      </div>
